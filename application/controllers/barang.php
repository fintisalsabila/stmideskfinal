...
function __construct(){
 ...
 function barang_list()
 {
        ...
        $databarang = $this->model_app->databarang();
	    $data['databarang'] = $databarang;
        
        $data['databarang'] = $this->model_app->databarang();

        // Generate QR Codes for each row
        foreach ($data['datauser'] as &$row) {
            $qrCode = new QrCode($row->id_barang);
            $row->qr_code = base64_encode($qrCode->output());
        }
 ...
 function save()
 {
 	...
 	$nama_barang = strtoupper(trim($this->input->post('nama_barang')));
    $stok = strtoupper(trim($this->input->post('stok')));
 	$id_jenis = strtoupper(trim($this->input->post('id_jenis')));
 ...
 function update()
 {
 	...
 	$id_barang = strtoupper(trim($this->input->post('id_barang')));
 	$nama_barang = strtoupper(trim($this->input->post('nama_barang')));
    $stok = strtoupper(trim($this->input->post('stok')));
    $id_jenis = strtoupper(trim($this->input->post('id_jenis')));
