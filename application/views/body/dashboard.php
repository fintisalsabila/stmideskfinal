    ...
    <div class="col-xs-6 col-md-3">
	<a href="<?php echo base_url(); ?>approval/approval_list" class="panel-link">
        <div class="panel panel-default">
            <div class="panel-body easypiechart-panel">
                <h4>Tiket Menunggu <br> Persetujuan Internal</h4>
...
<div class="col-xs-6 col-md-3">
    <a href="<?php echo base_url(); ?>approval/approval_list" class="panel-link">
        <div class="panel panel-default">
            <div class="panel-body easypiechart-panel">
                <h4>Tiket Menunggu <br> Persetujuan Teknisi</h4>
