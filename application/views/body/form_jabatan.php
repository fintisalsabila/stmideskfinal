		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading"><svg class="glyph stroked calendar"><use xlink:href="#stroked-pen-tip"></svg><a href="#" style="text-decoration:none">Tambah Data Jabatan</a></div>
